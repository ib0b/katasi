                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('signup') }}">
                        ...
                        <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            <label for="city" class="col-md-4 control-label">City or Town</label>
                        ...
                        <div class="form-group{{ $errors->has('mobile_number') ? ' has-error' : '' }}">
                            <label for="mobile_number" class="col-md-4 control-label">Mobile Number<span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                Required fields have an asterisks:*<hr>
